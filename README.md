...
Modeled after [motlin/claude-code-prompts](https://github.com/motlin/claude-code-prompts) but not as advanced. Also creates an AGENTS.md for Codex.
...
|:-------|:------------|:------------|
| Claude | `claude-md` | Merges instructions and agents, copies CLAUDE.md and settings.json |
